...
temp = auto.arima(ydata1.log[,], max.p = 0, seasonal = F)
plot(temp$fitted)
points(ydata1.log[1,])

ydata1.log.ma = apply(ydata1.log,1,function(x) auto.arima(x, max.p = 0, seasonal = F)$fitted )
ydata1.log.ma = t(ydata1.log.ma)
plot(ydata1.log.ma[1,],type="l")

plot(ydata1.log.ma[2,],type="l")
points(ydata1.log[2,])

plot(ydata1.log.ma[3,],type="l")
points(ydata1.log[3,])
