...
p1
#ggsave('Bellshaped_wo_spline_clique15_sd1_2_5.png', p1, width = 17,height=11, dpi = 300)
...
wo_spline = read.csv("Bellshaped_wo_spline_clique15_sd1_2_5.csv")
w_spline = read.csv("Bellshaped_spline_clique15_sd1_2_5.csv")

result = bind_rows(w_spline,wo_spline[-c(2,4),],.id="id")
